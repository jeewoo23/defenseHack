...
% outputs/images/aeris_dual_objective_metrics.png
% outputs/benchmark_plots/benchmark_dual_on_5seed.png
% outputs/benchmark_plots/benchmark_watch_off_5seed.png
% outputs/benchmark_plots/benchmark_watch_guarded_on_5seed.png
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.92\textwidth]{outputs/images/aeris_dual_objective_snapshots.png}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.92\textwidth]{outputs/benchmark_plots/benchmark_dual_on_5seed.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{outputs/benchmark_plots/benchmark_watch_off_5seed.png}
        \caption{Persistent watch disabled.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{outputs/benchmark_plots/benchmark_watch_guarded_on_5seed.png}
